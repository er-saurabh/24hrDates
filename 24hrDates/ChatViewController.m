...
- (void)viewDidLoad
{
    ...
    self.firebase = [(AppDelegate*)[[UIApplication sharedApplication] delegate] userRef];
    
    // Pick a random number between 1-1000 for our username.
    self.name = [NSString stringWithFormat:@"%@%d",[[[NSUserDefaults standardUserDefaults]valueForKey:@"login_name"] uppercaseString], arc4random() % 1000];
