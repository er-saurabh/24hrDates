...
- (void)panThisCell:(UIPanGestureRecognizer *)recognizer {
    switch (recognizer.state) {
        ...
        if (self.startingRightLayoutConstraintConstant == 0) { //1
            //Cell was opening
            CGFloat halfOfButtonOne = CGRectGetWidth(self.swipeBtn.frame) / 2; //2
            ...
            //Cell was closing
            CGFloat buttonOnePlusHalfOfButton2 = (CGRectGetWidth(self.swipeBtn.frame) / 2); //4
...
- (CGFloat)buttonTotalWidth {
    return CGRectGetWidth(self.frame) - CGRectGetMinX(self.swipeBtn.frame);
}
